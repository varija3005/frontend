        ...
        <>
            <div className='contact-us-section'>
                <div  data-aos="fade-up" data-aos-duration="1000">
                    ...
                    <h1 className='heading'>For inquiries, bulk orders, or more details, contact us today!</h1>
                </div>
                <div className='content' data-aos="fade-up" data-aos-duration="1000">
                    <div className='address'>
                        <h3>Where To Find Us</h3>
                        <p>#12/2-66 Krishanappa Layout, <br />R.R Nagar, Karekodi Main Road, <br />Hoskerehalli, Bangalore- 85</p>
                    </div>
